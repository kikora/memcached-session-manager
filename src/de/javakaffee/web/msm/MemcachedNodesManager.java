...
public class MemcachedNodesManager {
     ...
     */
    public MemcachedNodesManager(final String memcachedNodes,  final NodeIdList primaryNodeIds,  final List<String> failoverNodeIds,
                                  final LinkedHashMap<InetSocketAddress, String> address2Ids,
                                  final StorageKeyFormat storageKeyFormat,  final StorageClientCallback storageClientCallback) {
     ...
     */
    public String createSessionId( final String sessionId ) {
     ...
     */
    public String getNewSessionIdIfNodeFromSessionIdUnavailable( final String sessionId ) {
        if ( isEncodeNodeIdInSessionId() ) {
            final String nodeId = _sessionIdFormat.extractMemcachedId( sessionId );
     ...
     */
    public String changeSessionIdForTomcatFailover( final String sessionId, final String jvmRoute ) {
